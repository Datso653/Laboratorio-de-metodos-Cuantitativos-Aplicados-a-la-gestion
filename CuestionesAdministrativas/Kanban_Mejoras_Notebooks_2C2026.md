...
- [x] **T-17 · TODAS · La rúbrica, explicada**<br>Sacada de `Pautas_examen.pdf` y agregada a **los 12 notebooks tocados**: las dos partes obligatorias (4 puntos en cada una), los pesos reales (**85% interpretación** en la escrita, **85% claridad de código** en la práctica) y qué significa eso en la práctica. Con la advertencia de correr **Reiniciar y ejecutar todo** antes de entregar.
